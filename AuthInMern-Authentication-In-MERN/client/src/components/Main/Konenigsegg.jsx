...
import benzLogo from '../assests/konig.png';
import benzVideo from '../assests/Koenigsegg Gemera - 3D Cinematic Animation Made in Blender 2.92 [4K⧸30 fps].webm'; // Import the video file
...
const RollsRoyceCollectionPage = () => {
    return (
        <div className={styles.container}>
            ...
            <div className={styles.text}>Explore Our Konenigsegg Collection</div>
