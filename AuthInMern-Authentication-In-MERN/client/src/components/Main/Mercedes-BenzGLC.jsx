...
import image1 from '../assests/173429_Benz 2Mercedes-Benz GLC car image with black backg_xl-1024-v1-0.png';
import image2 from '../assests/173430_Benz 2Mercedes-Benz GLC car image with black backg_xl-1024-v1-0.png';
import image3 from '../assests/173431_Benz 2Mercedes-Benz GLC car image with black backg_xl-1024-v1-0.png';
import './MercedesEClassPage.css'; // Import CSS file for styling

const MercedesEClassPage = () => {
    // Sample data for Mercedes-Benz E-Class
    const carDetails = {
        modelName: "Benz 2Mercedes-Benz GLC",
        price: "$60,000",
        images: [
            image1,
            image2,
