...
import benzLogo from '../assests/BUGATTILOGO.jpg';
import benzVideo from '../assests/Y2meta.app - BUGATTI’s latest Masterpiece_ _La Voiture Noire_.mp4'; // Import the video file
...
const RollsRoyceCollectionPage = () => {
    return (
        <div className={styles.container}>
            ...
            <div className={styles.text}>Explore Our Bugatti Collection</div>
