...
import benzLogo from '../assests/bmwlogo.jpg';
import benzVideo from '../assests/BMW i8 - Technical Animation by Effekt-Etage.webm'; // Import the video file
...
const RollsRoyceCollectionPage = () => {
    return (
        <div className={styles.container}>
            ...
            <div className={styles.text}>Explore Our BMW Collection</div>
